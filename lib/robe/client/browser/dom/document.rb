# copied from opal-browser
# TODO: copyright notice

require 'robe/client/browser/dom/element'
...
module Robe; module Client; module Browser; module DOM
  ...
  class Document < Element
    ...
    def create_text(content)
      Element.new(`#@native.createTextNode(#{content})`)
    end
    ...
    def head
      Element.new(`#@native.getElementsByTagName("head")[0]`)
    end
